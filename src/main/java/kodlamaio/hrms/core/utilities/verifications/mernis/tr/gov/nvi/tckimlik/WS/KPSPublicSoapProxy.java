...
public class KPSPublicSoapProxy implements kodlamaio.hrms.core.utilities.verifications.mernis.tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  private String _endpoint = null;
  private kodlamaio.hrms.core.utilities.verifications.mernis.tr.gov.nvi.tckimlik.WS.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new kodlamaio.hrms.core.utilities.verifications.mernis.tr.gov.nvi.tckimlik.WS.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public kodlamaio.hrms.core.utilities.verifications.mernis.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
